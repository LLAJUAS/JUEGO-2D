...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    function restart() {
        // Asegúrate de que el juego pueda reiniciarse desde cualquier estado
        demo.classList.remove('hidden');
        splash.classList.add('hidden');
        maker.classList.remove('hidden');
        musica.pause();
        ...
        // Oculta las pantallas de "gameover" y "finishgame"
